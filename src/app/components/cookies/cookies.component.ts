...
export class CookiesComponent implements OnInit {
  ...
  ngOnInit() {
    (function () {
        ...
        // Buscamos la cookie "usocookies", si no está en el cliente decidimos mostrar el contenedor de la alerta
        if (!getCookie("usocookies")) {
        ...
        else if (getCookie("usocookies") == "true") {
            //location.href = "login";
        }
