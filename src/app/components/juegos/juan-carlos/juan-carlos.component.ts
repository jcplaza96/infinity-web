...
@Component({
  selector: 'app-juan-carlos',
  templateUrl: './juan-carlos.component.html',
  styleUrls: ['./juan-carlos.component.scss']
})
export class JuanCarlosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    function cargarImagenes() {
      ...
      imagenes[cartas].src = "/assets/img/jcgame/" + cartas + ".jpg";
      cartas++;
      if (cartas < 6) {
